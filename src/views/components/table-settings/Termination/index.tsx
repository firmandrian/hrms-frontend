...
const createData = (name: string, id: number): Data => {
  return { name, id }
}
...
const TableTermination = () => {
  ...
  const handleEdit = (id: number, event: React.MouseEvent<unknown>, name: string) => {
    setEditName(name)
    setEditId(id)
    setOpen(true)
  }
    ...
    <>
      ...
      >
        <Box sx={{ ...style, padding: 0 }}>
          <Typography id='modal-modal-title' variant='h6' component='h2'>
            <Borders
              statusText='Edit Termination Reasons'
              columns={[]}
              data={[]}
              showBordersBox={true}
      ...
      >
        <Box sx={{ ...style, padding: 0 }}>
          <Typography id='modal-modal-title' variant='h6' component='h2'>
            <Borders
              statusText='Add Termination Reasons'
              columns={[]}
              data={[]}
              showBordersBox={true}
              showDatePicker={false}
...
export default TableTermination
